...
var _helpers = {
    ...
    killWorkerProcess: killWorkerProcess,
    sendTo: sendTo,
};
...
if (process.env.NODE_QWORKER) {
    ...
    module.exports = function buildController(options) {
        ...
        self.run = function run( script, payload, callback ) {
...
function killWorkerProcess( worker, optionalCallback ) {
